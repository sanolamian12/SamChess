...
const EXPECTED: Record<BattleMode, { weights: Record<string, number>; offset: number }> = {
  '3v3': {
    weights: {
      might: 1.473, intellect: 0.471, leadership: 0.655,
      skillB: 5.56, skillA: 13.826, skillS: 34.082,
      hp: 6.567, mp: 0.604, at: 39.665,
    },
    offset: -130.619,
  },
  '5v5': {
    weights: {
      might: 0.776, intellect: 0.284, leadership: 0.412,
      skillB: 0, skillA: 4.863, skillS: 16.536,
      hp: 3.627, mp: 0.546, at: 22.593,
    },
    offset: -65.658,
  },
};
...
const FIXTURES: [string, BattleMode, string[], number, number][] = [
  ['3v3 Lv1 관우·장비·조운', '3v3', ['관우', '장비', '조운'], 1, 863],
  ['3v3 Lv9 관우·장비·조운', '3v3', ['관우', '장비', '조운'], 9, 1288],
  ['3v3 Lv1 헌제·조식·유선 (최약체 근처)', '3v3', ['헌제', '조식', '유선'], 1, 181],
  ['3v3 Lv5 가후·순욱·곽가 (지력형)', '3v3', ['가후', '순욱', '곽가'], 5, 832],
  ['5v5 Lv1 오호대장', '5v5', ['관우', '장비', '조운', '황충', '마초'], 1, 828],
  ['5v5 Lv9 오호대장', '5v5', ['관우', '장비', '조운', '황충', '마초'], 9, 1229],
  ['5v5 Lv5 헌제·조식·유선·동소·양수', '5v5', ['헌제', '조식', '유선', '동소', '양수'], 5, 543],
];
