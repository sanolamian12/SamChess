...
3. history/2026-08-12_액션시트_5자세_연출.md 의 §4(밟은 지뢰)·§5(구조)
4. history/2026-08-04_오프라인_풀사이클.md 의 §3(밟은 지뢰)·§4(구조)
...
| 순수 로직 | `npm test` (149건) | 스케줄러·판정·책략·고유기술·계정/편성/보상·**연출 시간표** |
