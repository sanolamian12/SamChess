...
>
> 최종 갱신 **2026-08-04** · 프로젝트 루트 `C:\Users\user\Documents\SamChess`
...
3. history/2026-08-04_전투씬_2차_UI.md 의 §3(밟은 지뢰)·§4(구조)
4. history/2026-08-02_룰엔진_고유기술_전투씬.md 의 §3(밟은 지뢰)
...
| C | 배치·정찰 화면 — 진영 내 자유 배치, 정찰 20초 | `ui/prepPanel.ts` · `battle/playback.ts` |
...
- **엔진은 시계를 갖지 않는다.** 절대시간은 전투가 시작해야 흐르고, 배치 60초·정찰 20초는
