...
1. 기물 타일 배지 4종 (좌상 고유기술 상태 / 우상 버프 / 좌하 급+레벨 / 우하 디버프) — GDD §3.10 ⬜ ← **다음**
...
| `packages/client/src/ui/controlModal.ts` | 제어 모달 3상태 — 활성 여부를 전부 `validate()`에 묻는다 |
